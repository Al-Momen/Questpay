                    ...
                    <form action="{{route('user.withdraw.money')}}" method="post">
                        ...
                        <div class="mt-3 preview-details d-none">
                            <ul class="list-group text-center">
                                ...
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>@lang('Receivable')</span> <span><span class="receivable fw--500"> 0</span>
    ...
    (function ($) {
        ...
        $('select[name=method_code]').on('change', function () {
            ...
            if (resource.currency != '{{ $general->cur_text }}') {
                var rateElement = `<span>@lang('Conversion Rate')</span> <span class="fw--500">1 {{__($general->cur_text)}} = <span class="rate">${rate}</span>  <span class="base-currency">${resource.currency}</span></span>`;
