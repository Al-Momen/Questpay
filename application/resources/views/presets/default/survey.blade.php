                        ...
                        <div class="survey-list__bottom-main d-flex justify-content-between flex-wrap">
                            ...
                            <div class=" input-search__box d-flex gap--12">
                                <div class="search__box  position-relative">
                                    <input type="text" class="form-control bottom-search__box"
                                        placeholder="@lang('Search Survey')...">
                                    ...
                                    <div class="filter__main">
                                        <div class="filter-meading__section">
                                            ...
                                            <div
                                                ...
                                                <h3 class="filter-heading__title fs--20 fw--600 mb-0">@lang('Filter')</h3>
                                                <p class="filter-heading__clear-btn cursor-pointer">@lang('Clear All')</p>
                                            </div>
                                            <div class="row g-4">
                                                <div class="col-lg-12">
                                                    <h4 class="category-title fs--16 fw--600 mb-2">@lang('Category')</h4>
                                                    <div class="filter__form">
                                                        @foreach ($categories ?? [] as $item)
                                                            <div
                                                                class="form-check d-flex justify-content-between align-items-center mb-4">
                                                                <label class="form-check-label fs--16 text-black" for="{{$item->id}}">
                                                                    {{__($item->name)}}
                                                                </label>
                                            ...
                                            <div class="dashboard-list__button w--100 mt-4">
                                                <a class="filter--btn w--100 fs--16 fw--600" href="#">@lang("Apply Now")</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @foreach ($surveys ?? [] as $item)
                            <div class="col-lg-4 col-md-6">
                                <div class="dashboard-list__items">
                                    <a href="#" class="dashboard-list__thumb mb-3 w--100">
                                        <img class="w--100 radius--12" src="{{ getImage(getFilePath('survey') . '/' . $item->image) }}"
                                    ...
                                    <div class="dashboard-list__content">
                                        ...
                                        <div class="dashboard-list__catagory d-flex justify-content-between">
                                            <div class="left-tag ps-3">
                                                ...
                                                <p class="fs-16 fw--400 text--black ps-4">{{ __($item->category->name) }}</p>
                                            </div>
