    ...
    <div class="row gy-4">
        <div class="col-md-12 mb-30">
            <div class="card b-radius--10 ">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center justify-content-end gap-2">
                                                <a href="{{ route('admin.survey.answer.detail', $item->id) }}"
                ...
                <div id="pagination-wrapper" class="pagination__wrapper py-4 {{ $surveyAnswers->hasPages() ? '' : 'd-none' }}">
                    @if ($surveyAnswers->hasPages())
                        {{ paginateLinks($surveyAnswers) }}
                    @endif
                </div>
            </div>
        </div>
